...
export default function About() {
  ...
  return (
    <div className="py-10 align-middle  bg-slate-100 px-10 flex flex-col gap-20 items-center sm:flex-row sm:pb-36  dark:bg-[_#2A262B]  sm:gap-28  sm:justify-center sm:pl-72 ">
